...
public enum BlockSide {
    ...
    // y-axis (-)
    Bottom(0, -1, 0, new BoxCorner[] { BoxCorner.BottomNorthEast, BoxCorner.BottomNorthWest, BoxCorner.BottomSouthWest,
        BoxCorner.BottomSouthEast }) {
    ...
    // y-axis (+)
    Top(0, 1, 0, new BoxCorner[] { BoxCorner.TopNorthEast, BoxCorner.TopNorthWest, BoxCorner.TopSouthWest,
        BoxCorner.TopSouthEast }) {
    ...
    // z-axis (-)
    North(0, 0, -1, new BoxCorner[] { BoxCorner.TopNorthWest, BoxCorner.TopNorthEast, BoxCorner.BottomNorthEast,
        BoxCorner.BottomNorthWest }) {
    ...
    // z-axis (+)
    South(0, 0, 1, new BoxCorner[] { BoxCorner.TopSouthEast, BoxCorner.TopSouthWest, BoxCorner.BottomSouthWest,
        BoxCorner.BottomSouthEast }) {
    ...
    // x-axis (-)
    West(-1, 0, 0, new BoxCorner[] { BoxCorner.TopSouthWest, BoxCorner.TopNorthWest, BoxCorner.BottomNorthWest,
        BoxCorner.BottomSouthWest }) {
    ...
    // x-axis (+)
    East(1, 0, 0, new BoxCorner[] { BoxCorner.TopNorthEast, BoxCorner.TopSouthEast, BoxCorner.BottomSouthEast,
        BoxCorner.BottomNorthEast }) {
    ...
    public static BlockSide getByYaw(float yaw) {
        ...
        // assume we're looking at a block. Return the side we're looking at rather than the direction in which we're
        // looking
