...
public class ShipIntermediaryClient {
    ...
    public static void onFoundHit() {
        ...
        double reachDist = Minecraft.getMinecraft().playerController != null
        ...
        // did we hit a ship?
        if (currentHit != null && currentHit.typeOfHit == MovingObjectType.ENTITY
            && currentHit.entityHit != null
            && currentHit.entityHit instanceof EntityShip) {
