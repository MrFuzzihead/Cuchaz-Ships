...
public class CoreModTransformer implements IClassTransformer {
	...
	public byte[] transform(String name, String transformedName, byte[] classData) {
		...
		try {
			...
			List<String> privilegedPackages = Arrays.asList("cuchaz.ships.", "cuchaz.modsShared", "net.minecraftforge.", "cpw.", "makamys.mixingasm.", "codechicken.nei.", "bq_standard.", "eu.ha3.matmos.", "technicianlp.reauth.", "betterquesting.", "com.falsepattern.", "it.unimi.dsi.", "stanhebben.zenscript.", "org.embeddedt.", "net.glease.", "ivorius.reccomplex.");
