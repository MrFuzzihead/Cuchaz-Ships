...
public enum ShipWorldPersistence {
        ...
        public ShipWorld onRead(World world, DataInputStream in) throws IOException, UnrecognizedPersistenceVersion {
            ...
            for (int i = 0; i < numHangingEntities; i++) {
                ...
                Coords coords = new Coords(
                    hangingEntity.field_146063_b,
                    hangingEntity.field_146064_c,
                    hangingEntity.field_146062_d);
        ...
        public void onWrite(ShipWorld shipWorld, DataOutputStream out) throws IOException {
            ...
            out.writeInt(
                shipWorld.tileEntities()
                    .size());
            for (TileEntity tileEntity : shipWorld.tileEntities()
                .values()) {
                ...
                try {
                    ...
                    Ships.logger.warning(
                        t,
                        "Tile entity %s on a ship at (%d,%d,%d) did not behave during a save operation!",
                        tileEntity.getClass()
                            .getName(),
                        tileEntity.xCoord,
                        tileEntity.yCoord,
            ...
            for (EntityHanging hangingEntity : shipWorld.hangingEntities()
                ...
                try {
                    ...
                    Ships.logger.warning(
                        t,
                        "Hanging entity %s on a ship at (%d,%d,%d) did not behave during a save operation!",
    ...
    protected abstract ShipWorld onRead(World world, DataInputStream in)
    ...
    public static ShipWorld readAnyVersion(World world, String data) throws PersistenceException {
        try {
            ...
            DataInputStream in = new DataInputStream(
                new GZIPInputStream(new Base64InputStream(new ByteArrayInputStream(data.getBytes(Encoding)))));
