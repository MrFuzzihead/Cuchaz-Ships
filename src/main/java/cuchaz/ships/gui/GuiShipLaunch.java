...
public class GuiShipLaunch extends GuiShip {
    ...
    public void initGui() {
        ...
        m_buttonLaunchShip = newGuiButton(
            0,
            LeftMargin,
        ...
        m_buttonRotateLeft = newGuiButton(
            1,
        ...
        m_buttonRotateRight = newGuiButton(2, m_width - LeftMargin - 20, m_height - TopMargin - 20, 20, 20, ">");
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.id == m_buttonLaunchShip.id) {
            ...
            Ships.net.getDispatch()
                .sendToServer(new PacketLaunchShip(m_shipLauncher.getShipBlock()));
            close();
    ...
    protected void drawForeground(int mouseX, int mouseY, float partialTickTime) {
        ...
        } else if (m_shipLauncher.getEquilibriumWaterHeight() != null
            && m_shipLauncher.getSinkWaterHeight() - m_shipLauncher.getEquilibriumWaterHeight() < 0.5) {
