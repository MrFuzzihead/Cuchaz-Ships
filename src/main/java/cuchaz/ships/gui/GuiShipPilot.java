...
public abstract class GuiShipPilot extends GuiBase {
    ...
    protected static enum ForwardSideMethod {
        ...
        ByPlayerLook {
            ...
            public BlockSide compute(EntityShip ship, EntityPlayer player) {
                ...
                Vec3 direction = Vec3
                    .createVectorHelper(player.posX - blockCenter.xCoord, 0, player.posZ - blockCenter.zCoord);
    ...
    protected GuiShipPilot(int width, int height, ResourceLocation background, EntityShip ship, EntityPlayer player,
        List<PilotAction> allowedActions, ForwardSideMethod forwardSideMethod) {
    ...
    public void initGui() {
        ...
        setPos((width - m_width) / 2, height - m_height - 48);
