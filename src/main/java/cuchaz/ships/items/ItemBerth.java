...
public class ItemBerth extends ItemBed {
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        BlockSide placementSide = BlockSide.getByYaw(player.rotationYaw)
            .getOppositeSide();
    ...
    private boolean isValidForBerthBlock(World world, int x, int y, int z, EntityPlayer player, int side,
        ItemStack itemStack) {
        return player.canPlayerEdit(x, y, z, side, itemStack) && world.isAirBlock(x, y, z)
